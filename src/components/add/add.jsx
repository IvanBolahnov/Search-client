...
import { createBook } from "../../store/reducers/actionCreator"
...
function Add() {
	...
	return (
		<div
			className={`add${isAddWindowOpened ? " add--open" : ""}`}
			inert={!isAddWindowOpened || isEditWindowOpened ? "" : undefined}
		>
			<form
				onSubmit={(e) => {
					e.preventDefault()
					dispatch(createBook({ name, author, year, tag }))
				}}
				className="add__form"
			>
				<h3 className="add__header">Добавить книгу</h3>
				<label className="add__input add__input--name">
					<svg
						width="24"
						height="24"
						viewBox="0 0 24 24"
				...
				<label className="add__input add__input--author">
					<svg
						width="24"
						height="24"
						viewBox="0 0 24 24"
				...
				<label className="add__input add__input--year">
					<svg
						width="24"
						height="24"
						viewBox="0 0 24 24"
				...
				<label className="add__input add__input--tag">
					<svg
						width="24"
						height="24"
						viewBox="0 0 24 24"
